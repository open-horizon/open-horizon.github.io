...
* Knotenrichtlinie für fußläufig erreichbare Geldautomaten in Wassernähe: properties: `camera-type: still`, `atm-type: walk-up`; constraints: `feature == glare-correction`
