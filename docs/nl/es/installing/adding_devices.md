...
* Dispositivo Intel&reg; o AMD de 64 bits o máquina virtual
...
4. Instale Docker siguiendo las instrucciones de [Instalación de CENTOS de Docker](https://docs.docker.com/engine/install/centos/).
