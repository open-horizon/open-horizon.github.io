...
- x86_64
  ...
  - {{site.data.keyword.fedora}} Workstation 36 - 43
...
- {{site.data.keyword.ieam}} {{site.data.keyword.version}} supports Podman 4.x on {{site.data.keyword.rhel}} 8.6 - 8.8, {{site.data.keyword.rhel}} 9.0 - 9.5, and {{site.data.keyword.fedora}} 36 - 43 Workstation.
