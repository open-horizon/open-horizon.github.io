...
* [Setting up a local image registry for a {{site.data.keyword.open_shift_cp}} edge cluster](../anax/docs/setting_up_ocp_image_registry.md)
* [Installing the agent on a {{site.data.keyword.open_shift_cp}} Kubernetes edge cluster](../anax/docs/installing_ocp_edge_cluster_agent.md)
