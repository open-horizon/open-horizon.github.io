...
{{site.data.keyword.edge_notm}} ({{site.data.keyword.edge_abbr}}) is built on the [Open Horizon Project ![Opens in a new tab](../images/icons/launch-glyph.svg "Opens in a new tab")](https://www.lfedge.org/projects/openhorizon/) open source software.
