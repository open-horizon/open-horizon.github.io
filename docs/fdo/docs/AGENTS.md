...
This document describes how documentation from the FDO-support repository is automatically published to the Open Horizon website.

## Source Locations

- **docs/** folder → Published to: https://open-horizon.github.io/docs/fdo/docs/

## Automation Process

The documentation publishing workflow follows these steps:

1. Changes are pushed to the master branch in the FDO-support repository
...
- Check GitHub Actions status in both repositories (FDO-support and open-horizon.github.io)
