...
<img src="../../images/edge/02a_Developing_AI_model_using_MMS.svg" width="90%" alt="MMS を使用した AI サービスの開発"> 

<img src="../../images/edge/02b_Updating_AI_model_using_MMS.svg" width="90%" alt="MMS を使用した AI サービスの更新"> 
